...
# this block can contain multiple items, items in a list are required
@dataclass 
class HivePartitioningOptionsItem():
        # non-optional-blocks
        mode: Optional[str] = None
        source_uri_prefix: Optional[str] = None
        
# wrapper list class
class HivePartitioningOptions(BlockList):
        items: List[HivePartitioningOptionsItem]
...
# wrapper list class
class MaterializedView(BlockList):
        items: List[MaterializedViewItem]
...
# this block can contain multiple items, items in a list are required
@dataclass 
class RangePartitioningItem():
        field:str
        # non-optional-blocks
        range: Optional[Range]=None,
        
# wrapper list class
class RangePartitioning(BlockList):
        items: List[RangePartitioningItem]
...
class GoogleBigqueryTable(ResourceObject):
    """    
    Args:
        dataset_id (str): The dataset ID to create the table in. Changing this forces a new resource to be created.
        table_id (str): A unique ID for the resource. Changing this forces a new resource to be created.
    """
    ...
    def __init__(self,
        ...
        view: Optional[View]=None,
            ...
            if hive_partitioning_options is not None:
                kwargs['hive_partitioning_options'] = hive_partitioning_options
            ...
            if materialized_view is not None:
                kwargs['materialized_view'] = materialized_view
            if range_partitioning is not None:
                kwargs['range_partitioning'] = range_partitioning
