...
class GoogleComputeRouterInterface(ResourceObject):
    """    
    Args:
        name (str): A unique name for the interface, required by GCE. Changing this forces a new interface to be created.
        router (str): The name of the router this interface will be attached to. Changing this forces a new interface to be created.
    """
