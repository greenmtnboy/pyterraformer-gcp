...
# this block can contain multiple items, items in a list are required
@dataclass 
class VmStartScheduleItem():
        schedule:str
        # non-optional-blocks
        
# wrapper list class
class VmStartSchedule(BlockList):
        items: List[VmStartScheduleItem]
...
# this block can contain multiple items, items in a list are required
@dataclass 
class VmStopScheduleItem():
        schedule:str
        # non-optional-blocks
        
# wrapper list class
class VmStopSchedule(BlockList):
        items: List[VmStopScheduleItem]
...
# this block can contain multiple items, items in a list are required
@dataclass 
class InstanceSchedulePolicyItem():
        time_zone:str
        # non-optional-blocks
        expiration_time: Optional[str] = None
        start_time: Optional[str] = None
        vm_start_schedule: Optional[VmStartSchedule]=None,
        vm_stop_schedule: Optional[VmStopSchedule]=None,
        
# wrapper list class
class InstanceSchedulePolicy(BlockList):
        items: List[InstanceSchedulePolicyItem]
...
class GoogleComputeResourcePolicy(ResourceObject):
    ...
    def __init__(self,
        ...
        instance_schedule_policy: Optional[InstanceSchedulePolicy]=None,
        ...
        timeouts: Optional[Timeouts]=None,
            ...
            if vm_start_schedule is not None:
                kwargs['vm_start_schedule'] = vm_start_schedule
            if vm_stop_schedule is not None:
                kwargs['vm_stop_schedule'] = vm_stop_schedule
            ...
            if instance_schedule_policy is not None:
                kwargs['instance_schedule_policy'] = instance_schedule_policy
