...
# this block can contain multiple items, items in a list are required
@dataclass 
class StackdriverLoggingConfigItem():
        sampling_ratio:float
        # non-optional-blocks
        
# wrapper list class
class StackdriverLoggingConfig(BlockList):
        items: List[StackdriverLoggingConfigItem]
...
class GoogleCloudTasksQueue(ResourceObject):
    ...
    def __init__(self,
        ...
        stackdriver_logging_config: Optional[StackdriverLoggingConfig]=None,
        timeouts: Optional[Timeouts]=None,
            ...
            if stackdriver_logging_config is not None:
                kwargs['stackdriver_logging_config'] = stackdriver_logging_config
