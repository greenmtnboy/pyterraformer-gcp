...
class GoogleCloudAssetOrganizationFeed(ResourceObject):
    """    
    Args:
        ...
        org_id (str): The organization this feed should be created in.
    """
    _type = 'google_cloud_asset_organization_feed'
