...
@dataclass 
class SqlServerUserDetailsItem():
        # non-optional-blocks
        disabled: Optional[bool] = None
        server_roles: Optional[List[str]] = None
        
# wrapper list class
class SqlServerUserDetails(BlockList):
        items: List[SqlServerUserDetailsItem]
...
class GoogleSqlUser(ResourceObject):
    ...
    def __init__(self,
        ...
        sql_server_user_details: Optional[SqlServerUserDetails]=None,
        timeouts: Optional[Timeouts]=None,
            ...
            if sql_server_user_details is not None:
                kwargs['sql_server_user_details'] = sql_server_user_details
