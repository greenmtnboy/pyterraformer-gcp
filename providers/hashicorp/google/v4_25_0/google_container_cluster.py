...
# this block can contain multiple items, items in a list are required
@dataclass 
class ExclusionOptionsItem():
        scope:str
        # non-optional-blocks
        
# wrapper list class
class ExclusionOptions(BlockList):
        items: List[ExclusionOptionsItem]
...
# this block can contain multiple items, items in a list are required
@dataclass 
class GcpFilestoreCsiDriverConfigItem():
        enabled:bool
        # non-optional-blocks
        
# wrapper list class
class GcpFilestoreCsiDriverConfig(BlockList):
        items: List[GcpFilestoreCsiDriverConfigItem]
...
class AddonsConfigItem():
        ...
        gcp_filestore_csi_driver_config: Optional[GcpFilestoreCsiDriverConfig]=None,
...
# wrapper list class
class DnsConfig(BlockList):
        items: List[DnsConfigItem]
    ...
    def __init__(self,
        ...
        workload_identity_config: Optional[WorkloadIdentityConfig]=None,
            ...
            if exclusion_options is not None:
                kwargs['exclusion_options'] = exclusion_options
            ...
            if gcp_filestore_csi_driver_config is not None:
                kwargs['gcp_filestore_csi_driver_config'] = gcp_filestore_csi_driver_config
