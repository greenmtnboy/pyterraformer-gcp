...
class GoogleFolderAccessApprovalSettings(ResourceObject):
    """    
    Args:
        folder_id (str): ID of the folder of the access approval settings.
    """
    _type = 'google_folder_access_approval_settings'
