...
class GoogleApigeeInstance(ResourceObject):
    """    
    Args:
        location (str): Required. Compute Engine location where the instance resides.
    ...
    def __init__(self,
        ...
        consumer_accept_list: Optional[List[str]] = None,
        ...
        timeouts: Optional[Timeouts]=None,
            ...
            if consumer_accept_list is not None:
                kwargs['consumer_accept_list'] = consumer_accept_list
