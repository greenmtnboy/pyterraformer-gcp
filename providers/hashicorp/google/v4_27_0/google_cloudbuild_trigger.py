...
# this block can contain multiple items, items in a list are required
@dataclass 
class ApprovalConfigItem():
        # non-optional-blocks
        approval_required: Optional[bool] = None
        
# wrapper list class
class ApprovalConfig(BlockList):
        items: List[ApprovalConfigItem]
    ...
    def __init__(self,
        ...
        webhook_config: Optional[WebhookConfig]=None,
            ...
            if include_build_logs is not None:
                kwargs['include_build_logs'] = include_build_logs
            ...
            if approval_config is not None:
                kwargs['approval_config'] = approval_config
