...
class GoogleComputeRouterNat(ResourceObject):
    ...
    def __init__(self,
        ...
        max_ports_per_vm: Optional[float] = None,
        ...
        timeouts: Optional[Timeouts]=None,
            ...
            if enable_dynamic_port_allocation is not None:
                kwargs['enable_dynamic_port_allocation'] = enable_dynamic_port_allocation
            if enable_endpoint_independent_mapping is not None:
                kwargs['enable_endpoint_independent_mapping'] = enable_endpoint_independent_mapping
            if icmp_idle_timeout_sec is not None:
                kwargs['icmp_idle_timeout_sec'] = icmp_idle_timeout_sec
            if id is not None:
                kwargs['id'] = id
            if max_ports_per_vm is not None:
                kwargs['max_ports_per_vm'] = max_ports_per_vm
