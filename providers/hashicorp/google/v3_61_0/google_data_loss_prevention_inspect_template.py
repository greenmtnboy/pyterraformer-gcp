...
# this block can contain multiple items, items in a list are required
@dataclass 
class StoredTypeItem():
        name:str
        # non-optional-blocks
        
# wrapper list class
class StoredType(BlockList):
        items: List[StoredTypeItem]
...
class CustomInfoTypesItem():
        ...
        info_type: Optional[InfoType]=None,
        regex: Optional[Regex]=None,
        stored_type: Optional[StoredType]=None,
        
# wrapper list class
class CustomInfoTypes(BlockList):
        items: List[CustomInfoTypesItem]
...
class InspectConfigItem():
        ...
        max_findings_per_info_type: Optional[MaxFindingsPerInfoType]=None,
        stored_type: Optional[StoredType]=None,
        custom_info_types: Optional[CustomInfoTypes]=None,
    ...
    def __init__(self,
        ...
        timeouts: Optional[Timeouts]=None,
            ...
            if stored_type is not None:
                kwargs['stored_type'] = stored_type
            if custom_info_types is not None:
                kwargs['custom_info_types'] = custom_info_types
