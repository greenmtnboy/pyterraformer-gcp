...
# this block can contain multiple items, items in a list are required
@dataclass 
class DefaultEncryptionConfigurationItem():
        kms_key_name:str
        # non-optional-blocks
        
# wrapper list class
class DefaultEncryptionConfiguration(BlockList):
        items: List[DefaultEncryptionConfigurationItem]
...
class GoogleBigqueryDataset(ResourceObject):
    ...
    def __init__(self,
        ...
        default_encryption_configuration: Optional[DefaultEncryptionConfiguration]=None,
        timeouts: Optional[Timeouts]=None,
            ...
            if default_encryption_configuration is not None:
                kwargs['default_encryption_configuration'] = default_encryption_configuration
