...
class GooglePrivatecaCertificate(ResourceObject):
    """    
    Args:
        location (str): Location of the Certificate. A full list of valid locations can be found by
                    running 'gcloud privateca locations list'.
        name (str): The name for this Certificate.
        pool (str): The name of the CaPool this Certificate belongs to.
    """
    ...
    def __init__(self,
        ...
        timeouts: Optional[Timeouts]=None,
            ...
            if certificate_authority is not None:
                kwargs['certificate_authority'] = certificate_authority
