...
@dataclass 
class ServiceDirectoryRegistrationsItem():
        # non-optional-blocks
        namespace: Optional[str] = None
        service: Optional[str] = None
        
# wrapper list class
class ServiceDirectoryRegistrations(BlockList):
        items: List[ServiceDirectoryRegistrationsItem]
...
class GoogleComputeForwardingRule(ResourceObject):
    ...
    def __init__(self,
        ...
        service_directory_registrations: Optional[ServiceDirectoryRegistrations]=None,
        timeouts: Optional[Timeouts]=None,
            ...
            if service_directory_registrations is not None:
                kwargs['service_directory_registrations'] = service_directory_registrations
