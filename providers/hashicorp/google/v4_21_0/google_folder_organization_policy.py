...
class GoogleFolderOrganizationPolicy(ResourceObject):
    """    
    Args:
        constraint (str): The name of the Constraint the Policy is configuring, for example, serviceuser.services.
        folder (str): The resource name of the folder to set the policy for. Its format is folders/{folder_id}.
    """
    _type = 'google_folder_organization_policy'
