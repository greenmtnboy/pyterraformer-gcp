...
# wrapper list class
class DefaultRouteAction(BlockList):
        items: List[DefaultRouteActionItem]
...
class PathMatcherItem():
        ...
        route_action: Optional[RouteAction]=None,
        url_redirect: Optional[UrlRedirect]=None,
        default_route_action: Optional[DefaultRouteAction]=None,
    ...
    def __init__(self,
        ...
        timeouts: Optional[Timeouts]=None,
            ...
            if default_route_action is not None:
                kwargs['default_route_action'] = default_route_action
