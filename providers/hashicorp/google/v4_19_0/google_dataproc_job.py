...
# wrapper list class
class PrestoConfig(BlockList):
        items: List[PrestoConfigItem]
...
class GoogleDataprocJob(ResourceObject):
    ...
    def __init__(self,
        ...
        presto_config: Optional[PrestoConfig]=None,
        ...
        timeouts: Optional[Timeouts]=None,
            ...
            if presto_config is not None:
                kwargs['presto_config'] = presto_config
