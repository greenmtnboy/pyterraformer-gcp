...
# this block can contain multiple items, items in a list are required
@dataclass 
class PosixDataSinkItem():
        root_directory:str
        # non-optional-blocks
        
# wrapper list class
class PosixDataSink(BlockList):
        items: List[PosixDataSinkItem]
...
# this block can contain multiple items, items in a list are required
@dataclass 
class PosixDataSourceItem():
        root_directory:str
        # non-optional-blocks
        
# wrapper list class
class PosixDataSource(BlockList):
        items: List[PosixDataSourceItem]
...
class TransferSpecItem():
        ...
        posix_data_sink: Optional[PosixDataSink]=None,
        posix_data_source: Optional[PosixDataSource]=None,
    ...
    def __init__(self,
        ...
        transfer_spec: Optional[TransferSpec]=None,
            ...
            if posix_data_sink is not None:
                kwargs['posix_data_sink'] = posix_data_sink
            if posix_data_source is not None:
                kwargs['posix_data_source'] = posix_data_source
