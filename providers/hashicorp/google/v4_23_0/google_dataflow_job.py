...
class GoogleDataflowJob(ResourceObject):
    ...
    def __init__(self,
        ...
        transform_name_mapping: Optional[Dict[str, str]] = None,
        ...
        timeouts: Optional[Timeouts]=None,
            ...
            if enable_streaming_engine is not None:
                kwargs['enable_streaming_engine'] = enable_streaming_engine
            if id is not None:
                kwargs['id'] = id
            ...
            if skip_wait_on_job_termination is not None:
                kwargs['skip_wait_on_job_termination'] = skip_wait_on_job_termination
            if subnetwork is not None:
                kwargs['subnetwork'] = subnetwork
            if transform_name_mapping is not None:
                kwargs['transform_name_mapping'] = transform_name_mapping
            if zone is not None:
                kwargs['zone'] = zone
