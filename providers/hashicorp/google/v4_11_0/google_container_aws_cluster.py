...
class GoogleContainerAwsCluster(ResourceObject):
    """    
    Args:
        aws_region (str): Required. The AWS region where the cluster runs. Each Google Cloud region supports a subset of nearby AWS regions. You can call to list all supported AWS regions within a given Google Cloud region.
