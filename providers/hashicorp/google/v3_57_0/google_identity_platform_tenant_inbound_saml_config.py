...
class GoogleIdentityPlatformTenantInboundSamlConfig(ResourceObject):
    """    
    Args:
        ...
        tenant (str): The name of the tenant where this inbound SAML config resource exists
    """
    _type = 'google_identity_platform_tenant_inbound_saml_config'
