...
# wrapper list class
class Versions(BlockList):
        items: List[VersionsItem]
...
# this block can contain multiple items, items in a list are required
@dataclass 
class SecretEnvironmentVariablesItem():
        key:str
        secret:str
        version:str
        # non-optional-blocks
...
# wrapper list class
class SecretEnvironmentVariables(BlockList):
        items: List[SecretEnvironmentVariablesItem]
...
# wrapper list class
class SecretVolumes(BlockList):
        items: List[SecretVolumesItem]
...
class GoogleCloudfunctionsFunction(ResourceObject):
    ...
    def __init__(self,
        ...
        secret_environment_variables: Optional[SecretEnvironmentVariables]=None,
        secret_volumes: Optional[SecretVolumes]=None,
        ...
        timeouts: Optional[Timeouts]=None,
            ...
            if docker_registry is not None:
                kwargs['docker_registry'] = docker_registry
            if docker_repository is not None:
                kwargs['docker_repository'] = docker_repository
            if entry_point is not None:
                kwargs['entry_point'] = entry_point
            if environment_variables is not None:
                kwargs['environment_variables'] = environment_variables
            if https_trigger_security_level is not None:
                kwargs['https_trigger_security_level'] = https_trigger_security_level
            ...
            if secret_environment_variables is not None:
                kwargs['secret_environment_variables'] = secret_environment_variables
            if secret_volumes is not None:
                kwargs['secret_volumes'] = secret_volumes
