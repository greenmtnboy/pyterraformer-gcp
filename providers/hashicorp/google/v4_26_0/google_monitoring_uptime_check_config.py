...
# this block can contain multiple items, items in a list are required
@dataclass 
class JsonPathMatcherItem():
        json_path:str
        # non-optional-blocks
        json_matcher: Optional[str] = None
        
# wrapper list class
class JsonPathMatcher(BlockList):
        items: List[JsonPathMatcherItem]
...
class ContentMatchersItem():
        ...
        json_path_matcher: Optional[JsonPathMatcher]=None,
    ...
    def __init__(self,
        ...
        timeouts: Optional[Timeouts]=None,
            ...
            if checker_type is not None:
                kwargs['checker_type'] = checker_type
            if id is not None:
                kwargs['id'] = id
            ...
            if json_path_matcher is not None:
                kwargs['json_path_matcher'] = json_path_matcher
