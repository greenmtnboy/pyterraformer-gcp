...
# this block can contain multiple items, items in a list are required
@dataclass 
class AdvancedOptionsConfigItem():
        # non-optional-blocks
        json_parsing: Optional[str] = None
        log_level: Optional[str] = None
        
# wrapper list class
class AdvancedOptionsConfig(BlockList):
        items: List[AdvancedOptionsConfigItem]
...
class GoogleComputeSecurityPolicy(ResourceObject):
    ...
    def __init__(self,
        ...
        expr: Optional[Expr]=None,
        match: Optional[Match]=None,
        advanced_options_config: Optional[AdvancedOptionsConfig]=None,
        ...
        timeouts: Optional[Timeouts]=None,
            ...
            if advanced_options_config is not None:
                kwargs['advanced_options_config'] = advanced_options_config
            if rule is not None:
                kwargs['rule'] = rule
