...
class GoogleFilestoreInstance(ResourceObject):
    ...
    Args:
        ...
        tier (str): The service tier of the instance. Possible values: ["TIER_UNSPECIFIED", "STANDARD", "PREMIUM", "BASIC_HDD", "BASIC_SSD", "HIGH_SCALE_SSD"]
        zone (str): The name of the Filestore zone of the instance.
    """
