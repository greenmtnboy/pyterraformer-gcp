...
# this block can contain multiple items, items in a list are required
@dataclass 
class DeadLetterPolicyItem():
        # non-optional-blocks
        dead_letter_topic: Optional[str] = None
        max_delivery_attempts: Optional[float] = None
        
# wrapper list class
class DeadLetterPolicy(BlockList):
        items: List[DeadLetterPolicyItem]
    ...
    def __init__(self,
        ...
        timeouts: Optional[Timeouts]=None,
            ...
            if enable_exactly_once_delivery is not None:
                kwargs['enable_exactly_once_delivery'] = enable_exactly_once_delivery
            if enable_message_ordering is not None:
                kwargs['enable_message_ordering'] = enable_message_ordering
            ...
            if dead_letter_policy is not None:
                kwargs['dead_letter_policy'] = dead_letter_policy
